			...
			<table cellpadding="5" cellspacing="5" border="0" width="600">
				<tbody>
					...
					<tr>
						...
						<form method="post"
							action="/PlantsByWebSphere/servlet/AdminServlet"><input
							...
							name="action" value="getbackorders"></form>
						</p>
						<br>
						</td>
					</tr>
               ...
               %>
					<tr>
						<td colspan="3">
						<blockquote><b>Back Order Items</b><br>
						</blockquote>
						<p>The <b>Back Order Items</b> list shows the inventory items that
						may be ordered from a supplier. Select one or more ordered items
						and click the <b>Order Stock</b> to send an order to the supplier.
						The <b>QUANTITY TO ORDER</b> may be changed before the order is
						submitted.</p>
						<br>
						<table width="524" border="0" cellpadding="2" cellspacing="10">
							<tbody>
								<form onsubmit="return verifyFields(this);" name="order"
									method="post" action="/PlantsByWebSphere/servlet/AdminServlet">
								<tr bgcolor="#eeeecc">
									...
									<th class="item" align="left" nowrap nowrap width="150">ITEM #</th>
									<th class="item" align="left" nowrap nowrap width="200">ITEM
									DESCRIPTION</th>
									<th class="item" align="left">QUANTITY TO ORDER</th>
									<th class="item" align="left">CURRENT INVENTORY QUANTITY</th>
                        ...
                        %>
								<tr>
									<td></td>
									<td></td>
									<td nowrap width="132"><input type="hidden" name="action"
										value="orderstock"> <input type="submit" name="Order Stock"
										value="Order Stock" class="buttons" id="orderstock"
										onClick='order.action.value="orderstock";return true'> <input
										type="hidden" name="admintype" value="backorder"></td>
									<td nowrap width="32"><input type="submit" name="Cancel"
										value="Cancel" class="buttons" id="cancel"
										onClick='order.action.value="cancel";return true'> <input
										type="hidden" name="admintype" value="backorder"></td>
								</tr>
								</form>
							</tbody>
					...
					<tr>
						<td colspan="3">
						<blockquote><b>Ordered Items</b><br>
						<br>
						</blockquote>
						<p>The <b>Ordered Items</b> list shows the inventory items that
						...
						<table width="600" border="0" cellpadding="2" cellspacing="10">
							<tbody>
								...
								<tr bgcolor="#eeeecc">
									...
									#</th>
									<th class="item" align="left" nowrap width="150">ITEM #</th>
                        ...
                        %>
								<tr>
									<td></td>
									<td nowrap width="132"><input type="hidden" name="action"
										value="orderstatus"> <input type="submit" name="Order Status"
										value="Order Status" class="buttons" id="orderstatus"
										onClick='order.action.value="orderstatus";return true'> <input
										type="hidden" name="admintype" value="backorder"></td>
									<td nowrap width="32"><input type="submit" name="Cancel"
										value="Cancel" class="buttons" id="cancel"> <input
										type="hidden" name="admintype" value="backorder"> <input
										type="hidden" name="action" value="cancel"></td>
								</tr>
								</form>
							</tbody>
						</table>
					...
					<tr>
						<td colspan="3">
						<blockquote><b>Received Items</b><br>
						<br>
						</blockquote>
						<p>The <b>Received Items</b> list shows the inventory items that
						have been received from a supplier but have not been added to the
						inventory. Select one or more ordered items and click the <b>Update
                        ...
                        %>
								<tr>
									...
									<td></td>
									<td nowrap width="132"><input type="hidden" name="action"
										value="updatestock"> <input type="submit" name="Update Stock"
										value="Update Stock" class="buttons" id="updatestock"
										onClick='received.action.value="updatestock";return true'> <input
										type="hidden" name="admintype" value="backorder"></td>
									<td nowrap width="32"><input type="submit" name="Cancel"
										value="Cancel" class="buttons" id="cancel"
										onClick='received.action.value="cancel";return true'> <input
										type="hidden" name="admintype" value="backorder"></td>
								</tr>
								</form>
							</tbody>
...
<table bgcolor="#669966" border="0" cellpadding="0" cellspacing="0"
	...
	<tbody>
		<tr>
			<td width="1"><img border="0" src="resources/images/1x1_trans.gif" width="1"
				height="1" alt=""></td>
		</tr>
	</tbody>
</table>
...
<table border="0" cellpadding="5" cellspacing="0" width="100%">
	<tr>
		...
		<p class="footer"><a class="footer"
			href="/PlantsByWebSphere/index.html" target="_top">Home</a>&nbsp;&nbsp;:&nbsp;
		<a class="footer" href="/PlantsByWebSphere/admin.html" target="_top">Admin
		Home</a>&nbsp;&nbsp;:&nbsp; <a class="footer"
			href="help.jsf" target="_blank">Help</a></p>
		</td>
	</tr>
</table>
</body>
