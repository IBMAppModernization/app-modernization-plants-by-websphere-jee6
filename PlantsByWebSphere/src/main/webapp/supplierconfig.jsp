...
<%@page import="com.ibm.websphere.samples.pbw.jpa.Supplier,,com.ibm.websphere.samples.pbw.utils.Util,java.util.*" session="true" isThreadSafe="true" isErrorPage="false"%>
<%
com.ibm.websphere.samples.pbw.jpa.Supplier supplierInfo = 
      (com.ibm.websphere.samples.pbw.jpa.Supplier) 
      session.getAttribute(com.ibm.websphere.samples.pbw.utils.Util.ATTR_SUPPLIER);
String id = "";
String name = "";
String street = "";
String city = "";
